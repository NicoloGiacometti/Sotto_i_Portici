    ...
    hotspots: [
      {
        ...
        position: [2, 1, 2],
        spritePath: asset('assets/sprites/objects/swing_portico.png'),
      },
      {
    ...
    hotspots: [
      {
        ...
        position: [1, 1, 1.5],
        spritePath: asset('assets/sprites/objects/foglio_ricetta.png'),
      },
      {
        id: 'videocassetta',
    ...
    npcs: [
      {
        ...
        name: 'Nonna Ines',
        spritePath: asset('assets/sprites/characters/nonna_ines_idle.png'),
        position: [0, 0, -2],
      },
    ],
  },
    ...
    hotspots: [
      {
        ...
        position: [1.5, 1, -1],
        spritePath: asset('assets/sprites/objects/diario_costanza.png'),
      },
      {
        id: 'disegno_parete',
        ...
        position: [-1.5, 1.4, -2],
        spritePath: asset('assets/sprites/objects/disegno_parete.png'),
      },
    ],
    npcs: [],
  },
    ...
    hotspots: [
      {
        ...
        position: [-2, 1, 1],
        spritePath: asset('assets/sprites/objects/poltrona_babbo.png'),
      },
      {
    ...
    npcs: [
      {
        ...
        name: 'Babbo Renzo',
        spritePath: asset('assets/sprites/characters/babbo_renzo_idle.png'),
        position: [-2, 0, 1.3],
      },
    ],
  },
    ...
    hotspots: [
      {
        ...
        position: [1.5, 1, -1],
        spritePath: asset('assets/sprites/objects/lettera_dottore.png'),
      },
      {
        id: 'scatola_polaroid',
        ...
        position: [-1.5, 1, -0.5],
        spritePath: asset('assets/sprites/objects/scatola_polaroid.png'),
      },
      {
    ...
    hotspots: [
      {
        ...
        position: [-2, 1, 0],
        spritePath: asset('assets/sprites/objects/bancone_osteria.png'),
      },
      {
    ...
    hotspots: [
      {
        ...
        position: [0, 0.5, -3],
        spritePath: asset('assets/sprites/objects/crollo_pozzo_argine.png'),
      },
    ],
    npcs: [],
  },
